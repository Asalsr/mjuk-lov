<!-- Scout Header
Purpose: Comprehensive framework for identifying, categorizing, and scoring technical debt types
When to use: When classifying detected debt items or need severity/impact assessment criteria
Size: ~548 lines
-->
