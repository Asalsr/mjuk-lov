<!-- Scout Header
Purpose: Catalog of refactoring patterns with examples, decision criteria, and before/after code samples
When to use: When recommending or applying refactoring fixes for identified tech debt
Size: ~1030 lines
-->
