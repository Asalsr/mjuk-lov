<!-- Scout Header
Purpose: Shared detection patterns (thresholds, grep patterns, heuristics) for code quality and debt analysis
When to use: When scanning a codebase for tech debt indicators or refactoring candidates
Size: ~123 lines
-->
