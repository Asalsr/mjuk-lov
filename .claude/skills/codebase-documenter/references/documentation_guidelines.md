<!-- Scout Header
Purpose: Writing style guide, formatting rules, and best practices for documentation generation
When to use: When generating README, architecture docs, API docs, or code comments
Size: ~523 lines
-->
