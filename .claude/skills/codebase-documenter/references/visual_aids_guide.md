<!-- Scout Header
Purpose: Patterns for ASCII diagrams, file trees, flowcharts, and sequence diagrams in documentation
When to use: When generating architecture docs or README with visual elements
Size: ~675 lines
-->
