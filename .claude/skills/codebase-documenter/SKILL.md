...
description: Use when writing documentation for codebases — README files, architecture docs, API documentation, or getting-started guides. Triggers on "document this repo", "create README", "write architecture docs", "explain this codebase", "onboarding guide", or any request to make a codebase more accessible to new developers.
context: fork
